...
if _has_sklearn:
    ...
    def acc_and_f1(preds, labels):
        ...
        f1_X_macro = f1_score(labels, preds, labels=[0], average='macro')
        f1_O = f1_score(labels, preds, labels=[5], average='micro')
        f1_O_macro = f1_score(labels, preds, labels=[5], average='macro')

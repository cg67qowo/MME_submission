...
from transformers import BertPreTrainedModel, BertModel, BertForTokenClassification, DistilBertPreTrainedModel, DistilBertModel
from transformers import CamembertTokenizer, CamembertModel, CamembertForTokenClassification
#from transformers.modeling_roberta import RobertaConfig, RobertaModel, RobertaClassificationHead, ROBERTA_PRETRAINED_MODEL_ARCHIVE_MAP
from transformers import RobertaConfig, RobertaModel
from transformers import XLMRobertaConfig, XLMRobertaModel, XLMRobertaForTokenClassification, AutoModelForTokenClassification
from torchcrf import CRF
from torch.nn import CrossEntropyLoss


class DistilBertForSequenceTagging(DistilBertPreTrainedModel):

    def __init__(self, config):
        super().__init__(config)
        self.num_labels = config.num_labels
        print(f"Check labels amount: {config.num_labels}")
...
class XLMRobertaForSequenceTagging(XLMRobertaModel):
...
class CamemBertForSequenceTagging(CamembertModel):
...
class XLMRobertaForSequenceClassificationWeighted(XLMRobertaModel):
    config_class = XLMRobertaConfig
    model = XLMRobertaModel.from_pretrained("xlm-roberta-base")
    base_model_prefix = "roberta"

    def __init__(self, config):
        super(XLMRobertaForSequenceClassificationWeighted, self).__init__(config)
        self.num_labels = config.num_labels
      ...
      #  model = XLMRobertaForTokenClassification.from_pretrained("xlm-roberta-base")
        ...
        self.classifier = XLMRobertaModel(config)

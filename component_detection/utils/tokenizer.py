...
from transformers import BertTokenizer, RobertaTokenizer, DistilBertTokenizer, CamembertTokenizer, XLMRobertaTokenizer
import os
...
class ExtendedBertTokenizer(BertTokenizer):
    ...
    def batch_to_conll(self, input_ids, label_ids, gold_label=None, processor=None, output_file=None):
       ...
       # import ipdb; ipdb.set_trace()
        assert tuple(input_ids.shape) == label_ids.shape
...
class ExtendedCamembertTokenizer(CamembertTokenizer):
    """BertTokenizer which extends a token-based list of labels to WordPiece sub-token-based list.
    Params, Inputs, Outputs:
        See base class.
    """
...
class ExtendedDistilBertTokenizer(DistilBertTokenizer):
    """BertTokenizer which extends a token-based list of labels to WordPiece sub-token-based list.
    Params, Inputs, Outputs:
        See base class.
    """
...
class ExtendedXLMRobertaTokenizer(XLMRobertaTokenizer):
    """BertTokenizer which extends a token-based list of labels to WordPiece sub-token-based list.
    Params, Inputs, Outputs:
        See base class.
    """
